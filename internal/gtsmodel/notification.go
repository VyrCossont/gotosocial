...
const (
	...
	NotificationFavourite     NotificationType = "favourite"         // NotificationFavourite -- someone faved/liked one of your statuses
	...
	NotificationAdminSignup   NotificationType = "admin.sign_up"     // NotificationAdminSignup -- someone has submitted a new account sign-up to the instance.
	NotificationAdminReport   NotificationType = "admin.report"      // NotificationAdminSignup -- someone has submitted a new account sign-up to the instance.
