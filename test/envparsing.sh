...
EXPECT=$(cat << "EOF"
{
    ...
    "search-embedding-api-base-url": "",
    "search-embedding-api-key": "",
    "search-embedding-backend": "",
    "search-embedding-distance-metric": "",
    "search-embedding-max-chars": 0,
    "search-embedding-model": "",
    "search-embedding-prompt-document": "",
    "search-embedding-prompt-query": "",
    "search-embedding-vector-size": 0,
    "skip-db-setup": false,
